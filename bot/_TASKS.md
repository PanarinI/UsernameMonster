...
- 
## В процессе
- [ ] оптимизация лога с отчетом (токены)
- [ ] добавить случайную генерацию темы запроса как кнопку-идею (отдельной веткой только)
- [ ] реализовать прием обратной связи от пользователей по генерации. Можно после генерации кнопку с автоматическим копированием результатов и комментарием пользователя
- [ ] выдавать пользователю список занятых ников 
- [ ] вместо стиля - категории из анализа: короче 10 символов, без подчериваний, без цифр. А также: уникальный неологизм; одно слово 
...
- [x] изменить формат f"Вот сгенерированные для вас username по теме '{context_text}':", чтобы отличалось
18.02
- [x] дополнительное подменю с выбором стиля генерации
- [x] ввод контекста должен заинтриговывать - прописать текст, добавить идею
- [x] описание уникальных преимуществ бота
- [x] этический warning - если AI отказывается генерировать по контексту
- [x] создание сообщества. Приветствие: это открытый проект. Предлагайте ваши идеи, куда его развернуть (обдумать такой вариант). Заодно это сообщество по поиску соавторов, единомышленников, клиентов


21.02
- [x] оптимизация времени генерации
