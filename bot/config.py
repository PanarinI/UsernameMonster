...
PROMPT = (
    ...
    "Когда и только когда в контексте прямо указано, что нужно придумать username для бота, то добавляй к концу username 'bot' или '_bot'"
